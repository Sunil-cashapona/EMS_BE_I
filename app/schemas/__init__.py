...
# try:
#     from app.schemas.user import UserCreate, UserEdit, UserResponse, UserRead
# except ImportError:
#     pass

# try:
#     from app.schemas.attendance import AttendanceCreate, AttendanceEdit, AttendanceRead
# except ImportError:
#     pass